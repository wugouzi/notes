...
\text{ s.t. }M(x\circ u)=1
     ...
     Assume \(M\) 1. \(M\) only has two tapes - an input tape and a work/output tape 2. \(M\) is an
     TM in the sense that its head movement does not depend on the contents of its tapes
     #+END_proof
