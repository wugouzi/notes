...
** 正态总体的样本均值与样本方差的分布
   ...
   #+BEGIN_proof
   2. [@2] 设\(Z_i=\frac{X_i-\mu}{\sigma}\)，则\(Z_1,\dots,Z_n\)相互独立，而
      \begin{gather*}
   ...
   3. \(\bbar{X}=\sigma\bbar{Z}+\mu=\frac{\sigma Y_1}{\sqrt{n}}+\mu\)仅依赖于\(Y_1\)
   4. 由 1，2，3
      \begin{equation*}
...
** 假设检验
   ...
   *拒绝域* ，拒绝域的边界点称为 *临界点*
   ...
   \end{equation*}
** 正态总体均值的假设检验
*** 单个总体\(N(μ,σ^2)\)均值\(μ\)检验
    1. \(\sigma^2\)已知，关于 \mu 检验（\(Z\)检验）
