...
#+LATEX_HEADER: \DeclareMathOperator{\MR}{MR}
#+LATEX_HEADER: \DeclareMathOperator{\MD}{MD}
* The Basics
...
** Countable models of \texorpdfstring{\(\aleph_1\)}{ℵ₁}-categorical theories
    ...
    #+BEGIN_proof
    Assume that \(b_1,\dots,b_n\) are algebraically independent over \(\varphi(M)\) but dependent over \(a\in M\).
    #+END_proof
