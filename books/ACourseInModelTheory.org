...
** Simplicity
    ...
    Check [[https://math.stackexchange.com/questions/3948865/the-tree-property-and-dividing-types][this]]. Skolemization
    ...
    with \(p(x)\). By Exercise ref:ex7.2.4 we can replace \(b\)
    #+END_proof
