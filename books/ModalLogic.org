...
** Appications
   ...
   *canonical* if its canonical frame is a frame for \(\Lambda\)
   #+END_definition
   ...
   related points. It is *right-unbounded* if every points has a successor.
   ...
   *trichotomous* if any two points are equal or are related one way or the other
   \((\foral xy(Rxy \vee x=y\vee Ryx))\) and a *weak total order* if it is both
