...
** The completeness theorem
   ...
   1. \(k\equiv 0\). Let \(\Pi\to\Lambda\) be any topmost sequent of the tree which has been defined
   ...
   2. \(k\equiv1\). Let \(\neg A_1,\dots,\neg A_n\) be all the formulas in \Lambda whose outermost logical
      ...
      to \(\neg A_1,\dots,\neg A_n\).
   3. \(k\equiv2\). Let \(A_1\wedge B_1,\dots,A_n\wedge B_n\) be all the formulas in \Pi whose
      ...
      \end{equation*}
   4. \(k\equiv3\). Let \(A_1\wedge B_1,\dots,A_n\wedge B_n\) be all the formulas in \Pi whose
      outermost logical symbols is \(\wedge\) and to which no reduction has been applied yet. Then
      write down
      \begin{equation*}
