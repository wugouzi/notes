...
\label{sec:org566a6f9}
\subsection{Modal Languages}
\label{sec:org1034d40}
\begin{definition}[]
...
uniformly replacing propostion letters in \(\phi\) by arbitrary formulas
...
\section{Models}
\label{sec:orgb9e8842}
\subsection{Invariance Results}
\label{sec:orge9db22c}
\begin{definition}[]
...
\label{sec:orgba5e78b}
\subsubsection{Generated submodels}
\label{sec:orgb2b8130}
\begin{definition}[]
...
\label{sec:org141d582}
\subsubsection{M-saturation}
\label{sec:org29f333b}
...
\section{Frames}
\label{sec:orgb73f7d7}

\subsection{Frame Definability}
\label{sec:org92e8738}
...
\label{sec:org56fbde1}
\subsubsection{Finite transitive frames}
\label{sec:orgdf9e601}
...
shows that each of states satisfies exactly one of propostion letter
...
all propostion symbols \(p\), \(V'(p)\) is definable in \(\fM\). If \(\fM'\)
...
\label{sec:org2f46d4d}
\subsection{Preliminaries}
\label{sec:orgbdb2c6c}
...
&\text{(Dual)}\quad&&\Diamond\leftrightarrow\neg\Box\neg p
\end{alignat*}
and is closed under generalization
\end{definition}
