...
\label{sec:orgada5c49}
\subsection{Modal Languages}
\label{sec:org9f37996}
\begin{definition}[]
...
\section{Models}
\label{sec:org5b9dc59}
\subsection{Invariance Results}
\label{sec:org3911966}
\begin{definition}[]
...
\label{sec:org4d8d531}
\subsubsection{Generated submodels}
\label{sec:orgbcad28a}
\begin{definition}[]
...
\label{sec:orgd13463f}
\subsubsection{M-saturation}
\label{sec:orge97e120}
...
\section{Frames}
\label{sec:org86218c1}

\subsection{Frame Definability}
\label{sec:org8a89e1d}
...
\label{sec:orgf5a334c}
\subsubsection{Finite transitive frames}
\label{sec:orgad5249f}
...
\label{sec:orgf0f8b16}
\subsection{Preliminaries}
\label{sec:org7f10f09}
...
\end{proof}
\subsection{Finitary Methods \rom{1}}
...
\begin{definition}[Canonical Model over $\Sigma$]
...
\begin{definition}[Regular PDL-model over $\Sigma$]
...
\begin{lemma}[Existence Lemma for Basic Programs]
...
\begin{definition}[Satisfiability and Validity Problems]
