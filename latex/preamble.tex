...
\usetikzlibrary{arrows.meta,positioning,calc,fadings,decorations,matrix,decorations.pathreplacing}
...
\setmathfont[range={\smwhtdiamond,\enclosediamond}]{Latin Modern Math}
...
% unicode-math doesn't have diamond
\renewcommand{\diamond}{\smwhtdiamond}
% \setmathfont{XITS Math}

% for leftrightarroweq
% \usepackage{boisik}
...
\renewcommand{\abs}{\@ifstar{\oldabs}{\oldabs*}}
%
\let\oldnorm\normm
