...
\end{equation*}
are provable. Now apply Craig's theorem to the latter sequent.
\end{proof}



\subsection{{\bfseries\sffamily TODO} ALL the problems}
\label{sec:orge816996}
\ref{Problem1}
\end{document}