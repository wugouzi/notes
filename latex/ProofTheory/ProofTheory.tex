...
\item Suppose \(\{\mu_m\}_{m<\omega}\) is a sequence of ordinals whose limit is \(\mu\) and suppose for
...
\begin{enumerate}
\item Construct a suitable standard ordering, in the strictly finitist standpoint
\item Convince oneself, in the Hilbert-Gentzen standpoint, that it is indeed a well-ordering
\item othewise use only strictly finitist means in the consistency proof
\end{enumerate}




\subsection{A Consistency Proof of \(\PA\)}
\label{sec:orge44151f}
