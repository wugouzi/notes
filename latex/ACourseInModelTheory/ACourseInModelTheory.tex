...
\section{The Basics}
\label{sec:org0a0aa65}

\subsection{Structures}
\label{sec:orgb3cf0cf}
\begin{definition}[]
...
\label{sec:org7692440}
\subsection{Elementary substructures}
\label{sec:org28caa18}
...
\label{sec:org3bb69ef}
\subsection{Preservation theorems}
\label{sec:org4520d3e}
...
\label{sec:orgd253768}
\subsection{The omitting types theorem}
\label{sec:org2e31a1b}
\begin{definition}[]
...
\label{sec:orgbc689a9}

\subsection{Indiscernibles}
\label{sec:org159688a}
\begin{definition}[]
...
Then \(\varphi(\fM,\bara)=\varphi(\fN,\bara)\) and the pair \((\fM,N,\bara)\) is a model of \(T^*\). This shows
that the theory
\begin{equation*}
...
\appendix
\section{Fields}
\label{sec:org7b7eb7f}
\subsection{Ordered fields}
\label{sec:org8ceeb0c}
