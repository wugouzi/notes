...
\section{The Basics}
\label{sec:org4658f16}

\subsection{Structures}
\label{sec:org61871a4}
\begin{definition}[]
...
\label{sec:org0329d84}
\subsection{Elementary substructures}
\label{sec:org02e7f6b}
...
\label{sec:orgd60c248}
\subsection{Preservation theorems}
\label{sec:org55eb1df}
...
\label{sec:orgbe594dc}
\subsection{The omitting types theorem}
\label{sec:orgf93821b}
\begin{definition}[]
...
\label{sec:org162dd48}

\subsection{Indiscernibles}
\label{sec:orgd2fbb87}
\begin{definition}[]
...
\item The formula p\(\varphi(\barx)\)p is \textbf{strongly minimal} if \(\varphi(\barx)\) defines a minimal set in all
...
and \((b_\alpha)_{\alpha<\kappa}\) of \(A\) and \(B\) s..t \(a_\alpha\in A_{\abs{\alpha}}\) and \(b_\alpha\in B_{\abs{\alpha}}\). We
...
\wu{
Fix a specialising chain \((\fM_\lambda)_{\lambda<\kappa}\). For any \(\fN\equiv\fM\) with \(\abs{\fN}\le\kappa\), then we have a
enumeration \((n_\alpha)_{\alpha<\kappa}\) of \(\fN\). Let \(A_\alpha=\{n_\beta:\beta<\alpha\}\).

Suppose \(f:A_\alpha\to\fM\) is elementary, let
\begin{equation*}
\Gamma(v)=\{\phi(v,f_\alpha(\bara)):\fM\vDash\phi(n_\alpha,\bara)\}
\end{equation*}
There is a sufficiently large \(\lambda_0\) s.t. \(f(A_\alpha)\subseteq\fM_{\lambda_0}\)
}
...
\appendix
\section{Set Theory}
\label{sec:org58363ae}
\subsection{Cardinals}
\label{sec:org6f5b471}
...
\section{Fields}
\label{sec:orgf0a5a2a}
\subsection{Ordered fields}
\label{sec:org3f3bfd8}
...
\label{sec:orgb2d6acb}
\subsection{Pregeometris}
\label{sec:orga08116f}
\begin{definition}[]
