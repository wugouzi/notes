...
\section{The Basics}
\label{sec:orgb190d5f}

\subsection{Structures}
\label{sec:org93e94ef}
\begin{definition}[]
...
\label{sec:orgc7e4022}
\subsection{Elementary substructures}
\label{sec:orgc85d506}
...
\label{sec:org75a56c2}
\subsection{Preservation theorems}
\label{sec:org2ae2861}
...
finitely many of the \(\varphi_{\fA_1}\) (Corollary \ref{cor2.2.5})
\end{proof}
...
\label{sec:orgaa5828d}
\subsection{The omitting types theorem}
\label{sec:org43857a8}
\begin{definition}[]
