...
\section{The Basics}
\label{sec:orgb44f653}

\subsection{Structures}
\label{sec:org9f31440}
\begin{definition}[]
...
\label{sec:org203f47a}
\subsection{Elementary substructures}
\label{sec:org795e487}
...
\label{sec:orged8686e}
\subsection{Preservation theorems}
\label{sec:orga0ca194}
...
\label{sec:org592798a}
\subsection{The omitting types theorem}
\label{sec:org666a420}
\begin{definition}[]
...
\begin{proof}
We can assume that \(T\) is small and not \(\aleph_0\)-categorical. We will show that \(T\) has at
...
\appendix
\section{Fields}
\label{sec:orgcbbf7bc}
\subsection{Ordered fields}
\label{sec:orgb472391}
