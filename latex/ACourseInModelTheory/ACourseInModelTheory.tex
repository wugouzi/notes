...
\section{The Basics}
\label{sec:org5ec6b21}

\subsection{Structures}
\label{sec:org376d1bd}
\begin{definition}[]
...
\label{sec:org0ed2543}
\subsection{Elementary substructures}
\label{sec:orgae81414}
...
\label{sec:org0ed44d7}
\subsection{Preservation theorems}
\label{sec:org672e375}
...
\label{sec:org0bc8979}
\subsection{The omitting types theorem}
\label{sec:orgda800c8}
\begin{definition}[]
...
\(\fB\not\models\varphi(\bbar{x},\bbar{a})\). Therefore \(\fA\not\models\varphi(\bbar{x},\bbar{a})\).
