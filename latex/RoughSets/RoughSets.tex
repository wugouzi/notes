...
\section{Knowledge}
\label{sec:org4c7c4ac}
\subsection{Knowledge base}
\label{sec:org2f20232}
...
\label{sec:org58d5115}
\subsection{Rough sets}
\label{sec:org70f2538}
...
\label{sec:orgcb02f7e}
\subsection{Reduct and Core of Knowledge}
\label{sec:orgf94bb5b}
...
\label{sec:orgfcfbb76}
\subsection{Dependency of knowledge}
\label{sec:orgd22d3c3}
...
\label{sec:org9f1cfbe}
\subsection{Formal definition}
\label{sec:orge5ef727}
...
algorithm \((P,Q)\) will be called \textbf{indepen;; [M-a] aligns all words at the left edge of the rectangle
