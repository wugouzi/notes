...
\section{Knowledge}
\label{sec:org0c36c9c}
\subsection{Knowledge base}
\label{sec:org7fc68aa}
...
\label{sec:orgf61dd3c}
\subsection{Rough sets}
\label{sec:org6689648}
...
\label{sec:org7dfa03a}
\subsection{Reduct and Core of Knowledge}
\label{sec:orgd1e8621}
...
\label{sec:orgaff82be}
\subsection{Dependency of knowledge}
\label{sec:org8c5ffb0}
...
\label{sec:orgf95d0f8}
\subsection{Formal definition}
\label{sec:orgb9e088f}
...
\label{sec:org9985baf}
\subsection{Formal definition and some properties}
\label{sec:org07928a8}
Let \(K=(U,A)\) vbe a knowledge representation system and let \(C,D\subset A\) be
...
\(U_2=\displystyle\bigcup_{X\in U/IND(D)}BN_C(X)\)
\end{proposition}
\begin{itemize}
\item \boxdot
\end{itemize}
