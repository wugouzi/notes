\message{ !name(RoughSets.tex)}% Created 2019-07-17 三 14:10
...
\message{ !name(RoughSets.tex) !offset(-3) }


\maketitle
\tableofcontents \clearpage\section{Knowledge}
\label{sec:org90be6f7}
\subsection{Knowledge base}
\label{sec:org4d3ee0e}
...
\label{sec:org433d79a}
\subsection{Rough sets}
\label{sec:org008770b}
...
\label{sec:orgc0d3bee}
\subsection{Reduct and Core of Knowledge}
\label{sec:orgbb88edf}
...
\label{sec:org022066d}
\subsection{Dependency of knowledge}
\label{sec:orgabcc16f}
...
\label{sec:orgd4ef235}
\subsection{Formal definition}
\label{sec:orga28668e}
...
\end{align*}
\end{document}
\message{ !name(RoughSets.tex) !offset(-1525) }
