...
\label{sec:org8b2db00}
\subsection{Basic Structure}
\label{sec:org441986b}
\begin{itemize}
...
\subsubsection{Summary}
\label{sec:orgbef8700}
\subsection{Hardware Opportunities}
\label{sec:org494f2fc}
\subsubsection{Large Memory}
\label{sec:orga4e085d}
\begin{itemize}
