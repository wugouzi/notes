...
\hypersetup{
 pdfauthor={},
 pdftitle={ForestDB: A Fast Key-Value Storage System for Variable-Length String Keys},
 pdfkeywords={},
 pdfsubject={},
 pdfcreator={},
 pdflang={English}}
...
\section{Background}
\label{sec:orgead934e}


\subsection{\texorpdfstring{\(\BP\)}{B+}-Tree and Prefix \texorpdfstring{\(\BP\)}{B+}-Tree}
\label{sec:org688dd2c}
...
\begin{center}
\includegraphics[width=.7\textwidth]{../../images/papers/144.png}
\captionof{figure}{\label{f1}Examples of \(\BP\)-tree and Prefix \(\BP\)-tree}
\end{center}
\subsection{LSM-Tree}
\label{sec:orgef7f354}
...
\captionof{figure}{\label{f3}The overview of Couchstore}
\end{center}
...
\begin{center}
\includegraphics[width=.7\textwidth]{../../images/papers/146.png}
\captionof{figure}{\label{f4}The overall architecture of ForestDB}
\end{center}
...
file permanently.
\subsection{\texorpdfstring{\(\HBP\)}{HB+}-Trie}
\label{sec:orgc12fe9b}
\begin{center}
\includegraphics[width=.7\textwidth]{../../images/papers/147.png}
\captionof{figure}{\label{f5}The hierarchical organization of \(\HBP\)-trie}
\end{center}
...
indicates
\begin{enumerate}
\item the chunk number used as a key for the tree
\item the skipped common prefix of the tree.
\end{enumerate}


\begin{center}
\includegraphics[width=.8\textwidth]{../../images/papers/149.png}
\captionof{figure}{\label{f7}An example of random key indexing using \(\HBP\)-trie}
\end{center}
...
\subsection{Optimizations for Avoiding Skew in \texorpdfstring{\(\HBP\)}{HB+}-Trie}
\label{sec:org34565eb}

\subsubsection{Overview}
\label{sec:org94334c5}
\begin{center}
\includegraphics[width=.7\textwidth]{../../images/papers/150.png}
\captionof{figure}{\label{f8}Skewed \(\HBP\)-trie examples}
\end{center}
...
\captionof{figure}{\label{f9}Examples of optimization for avoiding skew}
\end{center}
...
\captionof{figure}{\label{t1}Summary of notation}
\end{center}
...
\captionof{figure}{\label{f11}Write buffer example}
\end{center}
