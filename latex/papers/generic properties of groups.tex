...
\label{sec:orgafdc2c8}
\subsection{Introduction}
\label{sec:org08d1a74}
\begin{definition}[]
...
\begin{center}
\begin{tikzpicture}
  \draw[->] (0, 0) -- (2, 0) node[right] {$\mathbb{Q}$};
  ...
  \node at (0.4,0.8) {\(A\)};
  \node at (1.6,0.8) {\(B\)};
  \fill [gray, domain=0: 0.8, variable=\x,opacity=0.3]
  (0, -2)
  -- (0,2)
  -- (0.8, 2)
  -- (0.8, -2);
  \fill [gray, domain=1.2:2, variable=\x,opacity=0.3]
  (1.2, -2)
  -- (1.2,2)
  -- (2, 2)
  -- (2, -2);
