...
\label{sec:org636371b}
\subsection{Introduction}
\label{sec:org86483a6}
\begin{definition}[]
...
\wu{
complete here means the extension of \(p\) is unique. Then non-completeness means that there is
a \((a,b)\in R^2\) that \(y>b\) and \(y<b\) are both consistent with \(p(x,y)\).
}
