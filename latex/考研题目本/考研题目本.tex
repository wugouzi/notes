...
\section{微积分}
\label{sec:orgf3e5547}
\subsection{一元函数微分}
\label{sec:orgd11af41}
\begin{examplle}[]
设\(f'(x)\)连续，\(f(0)=0,f'(0)\neq0\)，求
...
\end{proof}
\section{线性代数}
\label{sec:orgd3ba7d3}
\subsection{行列式}
\label{sec:org882020f}
\begin{examplle}[]
计算行列式
\begin{equation*}
D_n=
