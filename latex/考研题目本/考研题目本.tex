...
\section{微积分}
\label{sec:orgbbd9519}
\subsection{一元函数微分}
\label{sec:org87258fe}
\begin{examplle}[]
设\(f'(x)\)连续，\(f(0)=0,f'(0)\neq0\)，求
...
\draw[line width=0.2pt,color=qqwuqq,smooth,samples=100,domain=-1.5:1.5] plot(\x,{(\x)^(3)});
