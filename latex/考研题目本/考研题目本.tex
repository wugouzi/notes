...
\section{微积分}
\label{sec:org4ce3581}
\subsection{一元函数微分}
\label{sec:org5720885}
\begin{examplle}[]
设\(f'(x)\)连续，\(f(0)=0,f'(0)\neq0\)，求
...
\end{examplle}
\section{线性代数}
\label{sec:org81de80e}
\subsection{行列式}
\label{sec:org49d1285}
\begin{examplle}[]
计算行列式
\begin{equation*}
D_n=
...
\end{examplle}
\section{概率论与数理统计}
\label{sec:orgde81a07}
\subsection{随机事件与概率}
\label{sec:orgb4d5344}
\begin{examplle}[]
