...
\tableofcontents \clearpage\% Created 2020-07-07 二 09:17
\% Intended \LaTeX{} compiler: pdflatex
\documentclass[11pt]{article}
\usepackage[utf8]{inputenc}
\usepackage[T1]{fontenc}
...
\hypersetup\{
 pdfauthor=\{Atiyah $\backslash$& Macdonald\},
...
\label{sec:org209ccf3}

\subsection*{Zerodivisors}
\label{sec:orgf6da16d}
...
\section{Modules}
\label{sec:orgf97cb1d}

\subsection*{Modules}
\label{sec:orgf6add14}
...
\label{sec:org7fbfb00}
\subsection*{Categories}
\label{sec:org94e3ccf}
...
\label{sec:org41bcee3}
\subsection*{Filtered categories}
\label{sec:org46aac5d}
...
\begin{theorem}[Exactness of filtered direct limits]
...
\label{sec:orgf71e0c8}
\subsection*{Bilinear maps}
\label{sec:orgbdf0c01}
...
\begin{theorem}[UMP of tensor product]
...
the image of \(\beta\). Finally, given any bilinear map \(\alpha:M\times N\to P\), by
