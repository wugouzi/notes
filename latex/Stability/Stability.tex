...
\label{sec:org4bd4a5c}
\subsection{Indiscernibles}
\label{sec:org95e88d4}
\begin{definition}[]
...
s.t. \(\{\phi(x,a_i)_{i\in\omega}\}\) is inconsistent (by compactness and \ref{C2.4.8} \label{Problem8})
\wu{
Tent Lemma 7.1.4
