...
\label{sec:org725f5f8}
\subsection{Languages and Structures}
\label{sec:org73d8f57}
\begin{definition}[]
...
\label{sec:org78583a2}
\subsection{The Compactness Theorem}
\label{sec:org8a08a28}
...
\label{sec:org878ab13}

\subsubsection{Dense Linear Orders}
\label{sec:org553d466}
...
\label{sec:org4b734ba}

\subsection{Quantifier Elimination}
\label{sec:orgdddabea}
...
\label{sec:orga741c72}

\subsection{Types}
\label{sec:orgfd8ca83}
...
&\calm\vDash\forall v_0,\dots,v_N\bigwedge_{i=0}^N\phi(v_i,\barw)\to\bigvee_{i<j\le N}v_i=v_j\Big\}
\end{align*}
For \(i\in X\), let \(N_i\) be the least \(N\) s.t. for some formula \(\phi\)
\begin{equation*}
\forall v_0,\dots,v_N\bigcap_{i=0}^N\phi(v_i,\barw)\to\bigvee_{i<j}v_i=v_j
\end{equation*}
is in \(q_i\).

If \(a,b_1,\dots,b_n\in M\) and \(a\) is algebraic over \(\barb\)
\end{proof}


\subsection{Exercise}
\label{sec:org0cb7877}

\section{Indiscernibles}
\label{sec:org55b4cf3}
\subsection{Partition Theorems}
\label{sec:orgcbb4b43}
...
\end{proof}
\section{Reference}
\label{sec:org43be4a1}
\bibliographystyle{alpha}
\bibliography{../references}
\section{Index}
\label{sec:orgc668f04}
