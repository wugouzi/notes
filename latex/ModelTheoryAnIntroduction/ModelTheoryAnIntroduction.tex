...
\label{sec:orgd4bc79b}
\subsection{Languages and Structures}
\label{sec:org856c946}
\begin{definition}[]
...
\label{sec:org1036545}
\subsection{The Compactness Theorem}
\label{sec:org1dbd81b}
...
\label{sec:orgb5615f1}

\subsubsection{Dense Linear Orders}
\label{sec:orge9d28e9}
...
\label{sec:org1e12f55}

\subsection{Quantifier Elimination}
\label{sec:org209c142}
\begin{definition}[]
...
\section{Set Theory}
\label{sec:org0691de0}
\subsection{Cardinal Arithmetic}
\label{sec:org965896c}
\begin{corollary}[]
\label{corA.15} 
\begin{enumerate}
...
\section{Reference}
\label{sec:orgb366299}
\bibliographystyle{alpha}
\bibliography{../references}
\section{Index}
\label{sec:org5fb089b}
