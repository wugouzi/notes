...
\label{sec:org8c80a74}
\subsection{Languages and Structures}
\label{sec:org213aaf6}
\begin{definition}[]
...
\label{sec:org711316f}
\subsection{The Compactness Theorem}
\label{sec:orgd92614e}
...
\label{sec:org0f714e1}

\subsubsection{Dense Linear Orders}
\label{sec:org1eab5b0}
...
\label{sec:org9cd4ce1}

\subsection{Quantifier Elimination}
\label{sec:orgf094a93}
...
\label{sec:orgc477af6}

\subsection{Types}
\label{sec:org5f3fb8e}
...
\begin{equation*}
 p_f\in\bigcup_{n=0}^\infty[\phi_{f|n}]
 \end{equation*}
...
\subsection{Exercise}
\label{sec:org81e71a3}

\section{Indiscernibles}
\label{sec:orgd5adcc3}
\subsection{Partition Theorems}
\label{sec:orgfbaa67b}
...
\section{Set Theory}
\label{sec:orgdb07fba}
\subsection{Cardinal Arithmetic}
\label{sec:org09bb2c0}
\begin{corollary}[]
\label{corA.15} 
\begin{enumerate}
