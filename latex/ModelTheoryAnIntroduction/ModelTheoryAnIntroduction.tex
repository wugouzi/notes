...
\label{sec:orge1ffe96}
\subsection{Languages and Structures}
\label{sec:org375f8d4}
\begin{definition}[]
...
\label{sec:org4b60c56}
\subsection{The Compactness Theorem}
\label{sec:org8491eab}
...
\label{sec:orgeb842e1}

\subsubsection{Dense Linear Orders}
\label{sec:org18cd21b}
...
\label{ex2.5.11}
Suppose that \(\calm_0\), \(\calm_1\) and \(\calm_2\)
\end{exercise}

\section{Algebraic Examples}
\label{sec:orgc1eb714}

\subsection{Quantifier Elimination}
\label{sec:orgf67e64d}
...
\label{sec:orgb923b35}

\subsection{Types}
\label{sec:org975e506}
...
\label{sec:org6899b67}
\subsection{Partition Theorems}
\label{sec:org3d011e3}
...
\label{sec:org2a215d0}
\emoji{😅}
\subsection{A Many-Models Theorem}
\label{sec:orgd1e1be9}
...
Because \(b_{n+1}\notin\acl(A,\barb)\), \(\caln\vDash\psi(\barb,b_{n+1})\). Thus \(\tp^{\calm}(\bara,a_{n+1}/A)=\tp^{\caln}(\barb,b_{n+1}/A)\)
\end{proof}
...
\end{equation*}
for all $\backslash$(m<\(\omega\)$\backslash$.)
\wu{
...
\end{proof}
\section{Reference}
\label{sec:org1cd1090}
\bibliographystyle{alpha}
\bibliography{../references}
\section{Index}
\label{sec:org55e56c5}
