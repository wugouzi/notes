...
\label{sec:org930b990}
\subsection{Languages and Structures}
\label{sec:org5b7e127}
\begin{definition}[]
...
\label{sec:orgc8490f5}
\subsection{The Compactness Theorem}
\label{sec:org42eccef}
...
\label{sec:org8438050}

\subsubsection{Dense Linear Orders}
\label{sec:org7597d91}
...
\label{sec:orga14e242}

\subsection{Quantifier Elimination}
\label{sec:org8deac55}
\begin{definition}[]
...
\label{sec:org8af3ab7}

\subsection{Types}
\label{sec:orgab91eda}
...
\begin{proof}
Let \(\Gamma=\{\phi(v,f(a_1),\dots,f(a_n)):\calm\vDash\phi(b,a_1,\dots,a_n),a_1,\dots,a_n\in B\}\cup\Diag_{\el}(\caln)\)
...
\end{equation*}
where \(\phi_1(\barv,\bara),\dots,\phi_m(\barv,\bara)\in p\). Because \(p\cup\Th_A(\calm)\) is consistent,
\begin{equation*}
...
\end{equation*}
and \(f(p)\cup\Th_{f(A)}(\caln)\) is consistent.
...
\label{sec:orgf95e8db}
\subsection{Partition Theorems}
\label{sec:orge19adc4}
...
\section{Set Theory}
\label{sec:orgbd5f0ea}
\subsection{Cardinal Arithmetic}
\label{sec:org551133a}
\begin{corollary}[]
\label{corA.15} 
\begin{enumerate}
