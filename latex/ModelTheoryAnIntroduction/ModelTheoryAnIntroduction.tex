...
\label{sec:orga612f83}
\subsection{Languages and Structures}
\label{sec:orga5a431f}
\begin{definition}[]
...
\label{sec:org3d65f85}
\subsection{The Compactness Theorem}
\label{sec:org2d6e8d0}
...
\label{sec:org6072508}

\subsubsection{Dense Linear Orders}
\label{sec:org4d64b0e}
...
\label{sec:orgfbeed7a}

\subsection{Quantifier Elimination}
\label{sec:orge8d4c5f}
\begin{definition}[]
...
\section{Set Theory}
\label{sec:org5ada24d}
\subsection{Cardinal Arithmetic}
\label{sec:orga3f7e53}
\begin{corollary}[]
\label{corA.15} 
\begin{enumerate}
...
then every element \(a\in E\) is a sum of squares, because \(4a=(1+a)^2-(1-a)^2\)
\section{Reference}
\label{sec:orgbc40f05}
\bibliographystyle{alpha}
\bibliography{../references}
\section{Index}
\label{sec:org778869c}
