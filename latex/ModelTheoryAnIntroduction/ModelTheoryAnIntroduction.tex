...
\label{sec:org6a85ed3}
\subsection{The Compactness Theorem}
\label{sec:org30778c6}
...
\label{sec:org4b8d666}

\subsubsection{Dense Linear Orders}
\label{sec:org72515ce}
...
\label{sec:org3963e0e}

\subsection{Quantifier Elimination}
\label{sec:org2601de6}
...
\label{sec:org9bac975}

\subsection{Types}
\label{sec:orge3b80af}
...
\label{sec:orgf20ee76}
\subsection{Partition Theorems}
\label{sec:orgaeb0212}
...
\label{sec:org6a143b4}
\emoji{😅}
\subsection{A Many-Models Theorem}
\label{sec:orgc39e116}
...
that \(\RM(\bara,b)\ge\RM(\bara)\).
\wu{
\(\tp(\bara,b)\supset\tp(\bara)\).
}
