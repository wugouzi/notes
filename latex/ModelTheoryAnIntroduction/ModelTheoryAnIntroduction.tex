...
\label{sec:org52c7f48}
\subsection{Languages and Structures}
\label{sec:org568ee5e}
\begin{definition}[]
...
\label{sec:orgf19547c}
\subsection{The Compactness Theorem}
\label{sec:org9550ef3}
...
\label{sec:org591ac8a}

\subsubsection{Dense Linear Orders}
\label{sec:org279714a}
...
\label{sec:org12f26dd}

\subsection{Quantifier Elimination}
\label{sec:org6a4a769}
\begin{definition}[]
...
\label{sec:orgcce2482}

\subsection{Types}
\label{sec:org01ef857}
...
field. Let \(k\) be a subfield of \(K\) generated by \(A\). If \(p\in S_n^K(k)\), then \(p|A\in S_n^K(A)\).

\section{Indiscernibles}
\label{sec:orga48f06f}
\subsection{Partition Theorems}
\label{sec:orgfbca0cd}
...
\section{Set Theory}
\label{sec:org0140c6a}
\subsection{Cardinal Arithmetic}
\label{sec:org8eece94}
\begin{corollary}[]
\label{corA.15} 
\begin{enumerate}
