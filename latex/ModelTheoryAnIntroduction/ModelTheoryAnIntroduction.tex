...
\label{sec:org993db4a}
\subsection{Languages and Structures}
\label{sec:org9c8b29f}
\begin{definition}[]
...
\label{sec:orgbfc1a50}
\subsection{The Compactness Theorem}
\label{sec:org8b8745f}
...
\label{sec:org20cc96a}

\subsubsection{Dense Linear Orders}
\label{sec:org790059d}
...
\label{sec:org7125323}

\subsection{Quantifier Elimination}
\label{sec:orgbe1dcfb}
...
\subsection{Exercises}
\label{sec:orgd4a1724}
\begin{exercise}
\label{ex3.4.3}
\begin{enumerate}
\item Show that the theory of \((\Z,s)\) has quantifier elimination where \(s(x)=x+1\). Shwo that
...
\label{sec:orge814bfb}

\subsection{Types}
\label{sec:org67aac9d}
...
\label{sec:orgb0b7d76}
\subsection{Partition Theorems}
\label{sec:org73843b1}
...
\label{sec:org92b6858}
\emoji{😅}
\subsection{A Many-Models Theorem}
\label{sec:orgf7b1bb1}
...
\begin{proof}
\(\Rightarrow\). If \(T\) is \kapp-categorical, then, by Corollaries \ref{cor5.2.10} and
...
and \(\caln\) as elementary extensions of \(\calm_0\). Then \(\dim(\phi(\calm))=\dim(\phi(\caln))=\kappa\). By Theorem
\ref{thm6.1.11} there is \(f:\phi(\calm)\to\phi(\caln)\), a partial elementary bijection. By Lemma
\ref{lemma6.1.17}, \(\calm\) is prime over \(\phi(\calm)\). Thus we can extend \(f\) to 
\end{proof}

\appendix
\section{Set Theory}
\label{sec:org62f189b}
\subsection{Cardinals}
\label{sec:org3b58858}
\(\kappa>\aleph_0\) is \textbf{inaccessible} if \(\kappa\) is a regular limit cardinal
\subsection{Cardinal Arithmetic}
\label{sec:org7229441}
\begin{corollary}[]
\label{corA.15} 
\begin{enumerate}
...
\end{proof}
\section{Reference}
\label{sec:orgc5ab6bd}
\bibliographystyle{alpha}
\bibliography{../references}
\section{Index}
\label{sec:org1b886dc}
