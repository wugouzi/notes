...
\label{sec:orgc693871}
\subsection{Languages and Structures}
\label{sec:orgc06a1d3}
\begin{definition}[]
...
\label{sec:orgc7567ec}
\subsection{The Compactness Theorem}
\label{sec:orge34bd94}
...
\label{sec:org59126e9}

\subsubsection{Dense Linear Orders}
\label{sec:org09690a8}
...
\label{sec:orgdb12d3e}

\subsection{Quantifier Elimination}
\label{sec:org78d314c}
...
Let \(\Gamma(\bar{v})=\{\psi(\bar{v}):\psi\text{ is quantifier free and }T\vDash\forall\bar{v}(\phi(\bar{v})\to\psi(\bar{v}))\}\). Let
\(d_1,\dots,d_m\) be new constant symbols. We will show that
\(T\cup\Gamma(\bar{d})\vDash\phi(\bar{d})\). Then, by compactness, there are
\(\psi_1,\dots,\psi_n\in\Gamma\) s.t. \label{Problem2}
\begin{equation*}
...
\label{sec:org947d6cd}

\subsection{Types}
\label{sec:org23892bf}
...
cardinality \(\kappa\) where every \(\emptyset\)-definable subsets of \(\calm\) has cardinality \(\kappa\). (Guess add \(\kappa\)
constants and each constant satisfies every formula) If \(T\) also has a \((\kappa,\lambda)\)-model,
...
\label{sec:org19647bb}
\subsection{Partition Theorems}
\label{sec:org858cd4c}
...
\label{sec:org3101ed5}
😅
\subsection{A Many-Models Theorem}
\label{sec:orgf3fcb92}
...
In Theorem \ref{thm5.2.10} and \ref{thm5.2.11}


\appendix
\section{Set Theory}
\label{sec:orgb6c4a5f}
\subsection{Cardinals}
\label{sec:org4a37c76}
\(\kappa>\aleph_0\) is \textbf{inaccessible} if \(\kappa\) is a regular limit cardinal
\subsection{Cardinal Arithmetic}
\label{sec:org6d446e8}
\begin{corollary}[]
\label{corA.15} 
\begin{enumerate}
...
\end{proof}
\section{Reference}
\label{sec:orgf256c8e}
\bibliographystyle{alpha}
\bibliography{../references}
\section{Index}
\label{sec:orga61c04b}
