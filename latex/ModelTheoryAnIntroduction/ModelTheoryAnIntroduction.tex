...
\label{sec:orgccd106e}
\subsection{Languages and Structures}
\label{sec:orgba2a4b2}
\begin{definition}[]
...
\label{sec:orgbb19bce}
\subsection{The Compactness Theorem}
\label{sec:orge1a5d49}
...
\label{sec:org9aa46b5}

\subsubsection{Dense Linear Orders}
\label{sec:org9d483f9}
...
\label{sec:orgfa85122}

\subsection{Quantifier Elimination}
\label{sec:org0501238}
...
\label{sec:orged503bb}

\subsection{Types}
\label{sec:org9f22f64}
...
\begin{equation*}
\Th_A(\calm)\vDash\exists\barw(\phi(\barv,\barw)\to\psi(\barv))
\end{equation*}
\end{proof}
...
let \(A_{\alpha+1}=A_\alpha\cup\{a_\alpha\}\). Let \(\calm_0\) be the substructure of \(\calm\) with universe \(A_\delta\)
\end{enumerate}
...
satisfiable. Because \(\calm\) is saturated, there is \(c\in M\) realizing \(\Gamma\). Thus \(f\cup\{(b,c)\}\) is
elementary and \(\calm\) is \(\kappa\)-homogeneous
\end{proof}

\subsubsection{Countably Saturated Models}
\label{sec:org61ec4d9}
\begin{proposition}[]
...
with \(\tp^{\calm_{\alpha+1}}(\barb,d)=\tp^{\calm_{\alpha+1}}(\bara,c)\). \label{Problem6}
...
\subsection{Exercise}
\label{sec:org8c9da63}

\section{Indiscernibles}
\label{sec:org83d5e77}
\subsection{Partition Theorems}
\label{sec:org1f36a56}
...
\subsection{Ehrenfeucht-Mostowski Models}
\label{sec:org6d2f799}
...
indiscernibles. \label{Problem1}


\section{Set Theory}
\label{sec:org4c49725}
\subsection{Cardinal Arithmetic}
\label{sec:org6776804}
\begin{corollary}[]
\label{corA.15} 
\begin{enumerate}
...
\section{Reference}
\label{sec:orgff7b057}
\bibliographystyle{alpha}
\bibliography{../../../../media/wu/file/stuuudy/notes/references}
\section{Index}
\label{sec:orgee7b36d}
