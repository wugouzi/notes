...
\label{sec:orgfe4706b}
\subsection{Languages and Structures}
\label{sec:org5e9b437}
\begin{definition}[]
...
\label{sec:orgbb12fdd}
\subsection{The Compactness Theorem}
\label{sec:org4b8fe94}
...
\label{sec:org8c0bff0}

\subsubsection{Dense Linear Orders}
\label{sec:orgc872934}
...
\label{sec:org96c8eb1}

\subsection{Quantifier Elimination}
\label{sec:orgd1cecaf}
...
\label{sec:orga3ef1ff}

\subsection{Types}
\label{sec:org69bf2a8}
...
\label{sec:orgda6b95e}
\subsection{Partition Theorems}
\label{sec:org426a2c3}
...
\label{sec:org803bea1}
\emoji{😅}
\subsection{A Many-Models Theorem}
\label{sec:orgc5f0482}
...
\section{Reference}
\label{sec:org1e9a8e6}
\bibliographystyle{alpha}
\bibliography{../references}
\section{Index}
\label{sec:org7223f8a}
