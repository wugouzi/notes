...
\label{sec:org1cca691}
\subsection{Languages and Structures}
\label{sec:org8d4eb0e}
\begin{definition}[]
...
\label{sec:org05ad2c9}
\subsection{The Compactness Theorem}
\label{sec:org8ebe12a}
...
\label{sec:org3b4e6a3}

\subsubsection{Dense Linear Orders}
\label{sec:orgd0779c7}
...
\label{sec:org3a92e3c}

\subsection{Quantifier Elimination}
\label{sec:org11f5aba}
...
\label{sec:org9ca2671}

\subsection{Types}
\label{sec:org8424a08}
...
\label{sec:org1f8682f}
\subsection{Partition Theorems}
\label{sec:org31ab669}
...
\end{equation*}
We call \(\tp(X)\) the \textbf{type of the indiscernibles}
...
set, we can find \(\caln\vDash T^*\)\footnote{\(\caln\vDash T\) on book, but \(\caln\vDash T^*\) is also true and it's used later} containing a sequence of order indiscernibles \(Y=(y_j:j\in J)\)
and \(\tp(X)=\tp(Y)\).
\end{lemma}
...
\begin{proof}
Let \(\kappa\ge\aleph_0\). By Lemma \ref{lemma5.2.5}, we can find
\end{proof}
\appendix
\section{Set Theory}
\label{sec:orge0346d6}
\subsection{Cardinals}
\label{sec:orga3690d0}
\(\kappa>\aleph_0\) is \textbf{inaccessible} if \(\kappa\) is a regular limit cardinal
\subsection{Cardinal Arithmetic}
\label{sec:org9958f99}
\begin{corollary}[]
\label{corA.15} 
\begin{enumerate}
...
\end{proof}
\section{Reference}
\label{sec:org33cc24c}
\bibliographystyle{alpha}
\bibliography{../references}
\section{Index}
\label{sec:orgb81bb3a}
