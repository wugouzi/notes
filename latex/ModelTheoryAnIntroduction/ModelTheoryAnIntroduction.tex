...
\label{sec:org831bdb6}
\subsection{Languages and Structures}
\label{sec:org6402867}
\begin{definition}[]
...
\label{sec:orgd60924c}
\subsection{The Compactness Theorem}
\label{sec:orged61b89}
...
\label{sec:orge3f4426}

\subsubsection{Dense Linear Orders}
\label{sec:org2518c50}
...
\label{sec:orgbacc661}

\subsection{Quantifier Elimination}
\label{sec:org53584a1}
...
\label{sec:org7508592}

\subsection{Types}
\label{sec:org806a5d9}
...
\label{sec:orgb565a89}
\subsection{Partition Theorems}
\label{sec:orgac209e6}
...
\label{sec:org9b69da1}
\emoji{😅}
\subsection{A Many-Models Theorem}
\label{sec:orgd2fd325}
...
\wu{
why do we want an \(\aleph_0\)-saturated model \label{Problem12}
}
...
\end{proof}
\section{Reference}
\label{sec:orge8ed487}
\bibliographystyle{alpha}
\bibliography{../references}
\section{Index}
\label{sec:org061f8c7}
