...
\label{sec:org552c513}
\subsection{随机实验}
\label{sec:org82836bc}
\subsection{样本空间、随机事件}
\label{sec:orga8e1dad}
...
\end{proof}
\section{多维随机变量及其分布}
\label{sec:org09234a4}
\subsection{二维随机变量}
\label{sec:orgdf9587b}
...
\label{sec:orge637c83}
\subsubsection{\(Z=X+Y\)分布}
\label{sec:org0beafe1}
...
\end{gather*}
\section{随机变量的数字特征}
\label{sec:orgb6209f4}
\subsection{数学期望}
\label{sec:org4ece3b9}
\begin{definition}[]
设离散型随机变量\(X\)的分布律
\begin{equation*}
...
\end{definition}
\section{大数定律及中心极限定理}
\label{sec:org94010ef}
\subsection{大数定律}
\label{sec:orga0571b7}
...
\end{theorem}
\section{样本及抽样分布}
\label{sec:org684e065}
\subsection{随机样本}
\label{sec:org305b01a}
...
\subsection{评估量的评选标准}
\label{sec:org0d39507}
\subsubsection{无偏性}
\label{sec:orgbdd28c4}
...
\label{sec:org8bce136}
\subsubsection{单个总体\(N(μ,σ^2)\)的情况}
\label{sec:orgedbe639}
...
\end{equation*}
\section{假设检验}
\label{sec:org8dcbcc8}
\subsection{假设检验}
\label{sec:org469be6f}
