...
\usepackage{hyperref}
\usepackage{minted}
\usepackage{xcolor, amsthm, mathabx, mathtools, pgfplots,amsmath, commath}
\input{preamble.tex}
\author{gouziwu}
\date{\today}
...
\label{sec:orgc024d83}
\subsection{2.1 Bisection method}
\label{sec:org96c18ca}
...
\label{sec:org9121a69}
\subsection{9.3 the power method}
\label{sec:org07f243c}
