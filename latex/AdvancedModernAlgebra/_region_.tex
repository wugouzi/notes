\message{ !name(AdvancedModernAlgebra.tex)}% Created 2020-02-19 三 20:33
...
\end{corollary}
\section{Group \rom{1}}
\label{sec:org3c6f92e}
\subsection{Permutations}
\label{sec:org1b1161a}
\begin{definition}[]
...
\label{sec:orgc0363f7}
\subsection{First Properties}
\label{sec:orge189b91}
...
\label{sec:org98294b4}
\subsubsection{Vector Spaces}
\label{sec:org6475800}
...
\section{Index}
\label{sec:orgee67b8c}
\printindex
\end{document}
\message{ !name(AdvancedModernAlgebra.tex) !offset(-3225) }
