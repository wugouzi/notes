...
\end{proposition}
\section{Group \rom{1}}
\label{sec:org3ff479c}
\subsection{Permutations}
\label{sec:orgf1699e5}
\begin{definition}[]
...
\label{sec:orgb934c08}
\subsection{First Properties}
\label{sec:org12b7184}
...
\label{sec:org70d25d3}
\subsubsection{Vector Spaces}
\label{sec:org17c2f10}
...
\end{exercise}
\section{Fields}
\label{sec:org82a71be}
\subsection{Insolvability of the Quintic}
\label{sec:org31eb219}
