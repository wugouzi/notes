...
\end{proposition}
\section{Group \rom{1}}
\label{sec:orgf19c570}
\subsection{Permutations}
\label{sec:orgcb615d1}
\begin{definition}[]
...
\label{sec:org1d781f3}
\subsection{First Properties}
\label{sec:orge96a0fa}
...
\label{sec:org932cba4}
\subsubsection{Vector Spaces}
\label{sec:orgfd01180}
...
(\pm b)^p=\alpha^{dp}=c^d
\end{equation*}
\uline{But \(p\) being prime and \(d<p\) forces \((d,p)=1\)}
\end{proof}

\section{Index}
\label{sec:org702e80b}
