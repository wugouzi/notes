...
\end{proposition}
\section{Group \rom{1}}
\label{sec:orgbfa2186}
\subsection{Permutations}
\label{sec:org57a27a1}
\begin{definition}[]
...
\label{sec:org2a42465}
\subsection{First Properties}
\label{sec:orgce399c0}
...
\label{sec:orgb917740}
\subsubsection{Vector Spaces}
\label{sec:org369e0fe}
...
\end{exercise}
\section{Fields}
\label{sec:org2d6300d}
\subsection{Insolvability of the Quintic}
\label{sec:orgc8f53f2}
...
(\(1,\alpha,\dots,\alpha^{d-1}\) is an basis), so that
...
\label{sec:orgbfb19cd}
\subsection{Finite Abelian Groups}
\label{sec:org034e914}
\subsubsection{Direct Sums}
\label{sec:org7e2d309}
...
\begin{proof}
Let \(\widetilde{\varphi}:\Z[x]\to\F_p[x]\) and let \(\widebar{f}(x)\) denote 
...
Thus \(\widebar{f}=\widebar{g}\widebar{h}\).
\end{proof}
\subsection{Noetherian Rings}
\label{sec:org934324b}
\begin{definition}[]
