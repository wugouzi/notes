...
\end{proposition}
\section{Group \rom{1}}
\label{sec:orga09b808}
\subsection{Permutations}
\label{sec:orge632fa3}
\begin{definition}[]
...
\label{sec:orgc853222}
\subsection{First Properties}
\label{sec:orge4519a5}
...
\label{sec:orgde589ba}
\subsubsection{Vector Spaces}
\label{sec:orgf533321}
...
\end{exercise}
\section{Fields}
\label{sec:orgbfe6923}
\subsection{Insolvability of the Quintic}
\label{sec:orgb0bd36b}
