...
bracket system
\section{Compactness}
\label{sec:orgbec75ec}
\subsection{Ultraproducts}
\label{sec:org68d5866}
...
\label{sec:orge6d6810}

\subsection{Omitting types theorem}
\label{sec:org8049d15}
...
\label{sec:orga95197d}

\subsection{Definable types}
\label{sec:org4ffe36a}
\begin{definition}[]
...
\label{sec:org4e4f624}
\subsubsection{Coheir independence}
\label{sec:org2115cf1}
\begin{definition}[]
...
\label{sec:orgdcca4da}
\subsubsection{Morley sequence}
\label{sec:orgc2ee038}
\begin{lemma}[]
...
\label{sec:orgf2ca5bc}
\subsection{EI in PA and ACF}
\label{sec:org0d3d9bf}
\(\Q\) is 0-definable
