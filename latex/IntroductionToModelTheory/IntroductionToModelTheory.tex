...
bracket system
\section{Compactness}
\label{sec:org123aafd}
\subsection{Ultraproducts}
\label{sec:org874c1ff}
...
\label{sec:orgeedb9f1}

\subsection{Omitting types theorem}
\label{sec:orga8a4f89}
...
\label{sec:org4e59bda}

\subsection{Definable types}
\label{sec:org36affad}
\begin{definition}[]
...
\label{sec:orgef870ce}
\subsubsection{Coheir independence}
\label{sec:org052cf11}
\begin{definition}[]
...
\label{sec:org4946876}
\subsubsection{Morley sequence}
\label{sec:org9853eb1}
\begin{lemma}[]
...
\label{sec:orgbb3ef51}
\subsection{EI in PA and ACF}
\label{sec:org2964829}
\(\Q\) is 0-definable
...
\begin{center}\begin{tikzcd}[col set=small]
