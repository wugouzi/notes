...
\begin{center}
\includegraphics[width=0.8\textwidth]{/media/wu/file/stuuudy/notes/images/ComputationalComplexity/1.png}
\end{center}
...
\begin{proof}
\begin{center}
\includegraphics[width=.5\textwidth]{/media/wu/file/stuuudy/notes/images/ComputationalComplexity/2.png}
\end{center}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=.5\textwidth]{/media/wu/file/stuuudy/notes/images/ComputationalComplexity/3.png}
\end{figure}
\end{proof}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=.5\textwidth]{/media/wu/file/stuuudy/notes/images/ComputationalComplexity/4.png}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=.8\textwidth]{/media/wu/file/stuuudy/notes/images/ComputationalComplexity/5.png}
\end{figure}
...
\item The Web of Reductions
\label{sec:orgde67f0f}
\begin{figure}[htbp]
\centering
\includegraphics[width=.9\linewidth]{/media/wu/file/stuuudy/notes/images/ComputationalComplexity/6.png}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=.9\linewidth]{/media/wu/file/stuuudy/notes/images/ComputationalComplexity/7.png}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=.9\linewidth]{/media/wu/file/stuuudy/notes/images/ComputationalComplexity/8.png}
\end{figure}
