...
\subsection{Queries}
\label{sec:org31ce091}
The relational model is independent of any query language implementation

SQL is the standard

\section{Intermediate SQL}
\label{sec:org67feb49}
...
\label{sec:orgf642f79}
\subsubsection{String operations}
\label{sec:org734f2f7}
\begin{center}
\begin{tabular}{lll}
...
\label{sec:org52d32c9}
\subsubsection{linear probe hashing}
\label{sec:orgd411b4b}
...
\label{sec:org09a4c98}
\subsubsection{Chained hashing}
\label{sec:org752662c}
...
\label{sec:org42e55f6}
\subsection{Design choices}
\label{sec:org799ed18}
\subsubsection{node size}
\label{sec:org8ddfae9}
...
\label{sec:orgc6f58b0}
\subsubsection{prefix compression}
\label{sec:orgcd4a080}
...
\label{sec:org76dd4ad}
\subsection{Latches Overview}
\label{sec:org148dd06}
\textbf{Locks}
\begin{itemize}
...
\label{sec:org3d507af}
\begin{enumerate}
\item Blocking OS Mutex
\label{sec:orgeae0a08}
...
\label{sec:org0607143}
\subsection{External Mergre Sort}
\label{sec:org68419d6}
...
\label{sec:org8d24704}

\subsection{Aggregations}
\label{sec:orge9992ba}
...
\label{sec:org9eb44d3}
\begin{enumerate}
\item Phase 1: Partition
\label{sec:org6f0985a}
\begin{itemize}
...
\label{sec:org2c0c232}

\subsubsection{Nested Loop Join}
\label{sec:org50d8deb}
\begin{enumerate}
\item Simple/Stupid
\label{sec:org2cb3be1}
...
\label{sec:org3a7ae85}
\subsection{Processing Models}
\label{sec:org6a03f8f}
