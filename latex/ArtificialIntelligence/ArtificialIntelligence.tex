...
\label{sec:orge8cbf3e}
\subsection{Basic concepts}
\label{sec:org25bd8fd}
\begin{itemize}
...
\label{sec:orgefdc006}
\begin{enumerate}
\item Least-squares approach
\label{sec:org235f51f}
\begin{itemize}
\item Problem
\begin{itemize}
...
\label{sec:org5b8a1e4}
\subsection{K-means clustering}
\label{sec:orga34e747}
...
\label{sec:org03f60c8}
\subsubsection{the general EM algorithm}
\label{sec:orgee901ef}
...
\label{sec:orgf169dbb}
\subsection{PCA}
\label{sec:org9cf19d6}
...
\label{sec:orgb773a64}
\subsection{Neural networks}
\label{sec:org7a7b5e4}
\subsubsection{biological inspiration}
\label{sec:org48e7d9b}
...
\label{sec:org46f1956}

\subsection{Appication of deep learning}
\label{sec:org72ccd46}

\subsection{Recurrent Neural Network(RNN)}
\label{sec:org579e2d7}
\subsubsection{RNN}
\label{sec:org4de5132}
...
\label{sec:orgf95c859}
\subsection{About RL}
\label{sec:org6a8f925}
