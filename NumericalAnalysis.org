...
- [[#chap7-iterative-techiniques-in-matrix-algebra][Chap7 Iterative techiniques in Matrix algebra]]
  - [[#71-norms-of-vectors-and-matrices][7.1 Norms of vectors and matrices]]
...
** 7.1 Norms of vectors and matrices
   ...
   \begin{enumerate}
   \item $||\mathbf{A}||\ge0;||\mathbf{A}||=0\Longrightleftarrow \mathbf{A}=\mathbf{0}$
   ...
   *Natural Norm*: $||\mathbf{A}||_p=\displaystyle\max_{\mathbf{x}\neq
   ...
   $||\mathbf{A}||_\infty=\displaystyle\max_{1\le i\len}\displaystyle\sum_{j=1}^n|a_{ij}|$,
