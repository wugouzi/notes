...
* Destroy
** weapon
   Horn, cutlass, katana, scourge, scythe, slingshot, buckler shield,
   aklys, sling, shortbow, 2h sword, mace, blowpipe, shovel,
   harpoon, dirk, poker, arrow, lance, foil,
   sai, flamberge, battle mace, bullet, ranseur, ice pick, voulge, sabre,
   falchion, hand-axe, wakizashi, shuriken,
   medium crossbow,  bardiche, chain whip,  morningstar,
   medium shield,  no-dachi, large
   shield, great axe, bolt, light crossbow, heavy crossbow,
   fauchard, glaive, longbow, rapier, scimitar and composite bow
** Armour
   Pouch,  horn, staff, scarab, mail shirt,  cape, bra,
   muff,  boot, great cloak, pendant, haidate, ball, shoe, kilt,
   elfin chain mail, tail ring,  gorget, shirt,
   o-yoroi, hangote, elfin plate, tail guard, hanburi, sode, sune-ate,
   turban, sleeve, banded plate, battlesuit, splint mail, bracelet, tome,
   medallion, kote, field plate, padded armour, tunica, mail coat,
   sleeved coat, finger guard, skull, coat, gauntlet, great helm, rod,
   mail cloak, kabuto, sleeved mail coat, bandolier, bracelets, sleeves,
   scarf, sollerets, sandals, bow tie, equipment frame,
   great boots, pot helm, studded armour, glove, scale
   mail, jangasa, full plate, jackboots,  slippers,
   satchel, wings, mask, girdle, horo.
** clothing
   Necklace, belt, mantle, blouse, garter belt, long coat, cape, robe, smock,
   frock, chemise, cowl, bra, pair of stockings, hooded cloak, skirt, jerkin,
   cap, apron, kilt, long skirt, fillet, vest, skullcap, shirt, corset, hood,
   tunic, choker, sleeveless dress, pair of panties, shoes, pair of shorts, full
   apron, tight dress, alb, short sleeved shirt, skimpy pair of panties, pair of
   pants, toga, sleeve, headdress, dungaree, suit, baldric,
   chaperon, headband, codpiece, boots, shawl, tunica, pair of socks, top,
   coat, sweater, liripipe, coif, chlamys, circlet, bracco,
   snood, bowler, breeches, scarf, sandals, bow tie, gown, drawers, tuxedo, tie,
   glove, cloak, sagum, sash, torque, hose, skimpy pair of shorts, fedora, short
   dress, muscle shirt, cote, slippers, loincloth, tight skirt, girdle, chiton,
   hat, dress, cotehardie, short skirt, doublet and veil
* Spider Demons
  tasisyreq-ufa

  | Name         | tasisyreq-ufa |           |        |              |      |
  | Might        |               |           |        |              |      |
  | Hit Points   | mediocre      | HP regen  |        |              |      |
  | Spell Points | fair          | SP regen  |        |              |      |
  | Endurance    | none          | EP regen  | superb |              |      |
  | Hit Bonus    | none          | Def Bonus | fair   | Dmg Bonus    | none |
  | Strength     | great         | Dexterity | none   | Constitution | fair |
  | Intelligence | none          | Wisdom    | none   |              |      |
  | Resistances  |               |           |        |              |      |
  | Physical     | none          | Mystical  |        |              |      |
  | Flame        | none          | Frost     | fair   |              |      |
  | Venom        | none          | Shock     |        |              |      |
  | Suffocation  |               | Mental    |        |              |      |
  | Corrosion    | none |           |        |              |      |
  | Metabosim    | none          |           |        |              |      |
  ...
  | Name         | avyqapepe-avy |           |        |              |          |
  | Might        |               |           |        |              |          |
  | Hit Points   | medicore      | HP regen  | none   |              |          |
  | Spell Points | fair          | SP regen  |none    |              |          |
  | Endurance    | none          | EP regen  | great  |              |          |
  | Hit Bonus    | none          | Def Bonus | none  | Dmg Bonus    | superb   |
  | Strength     | none          | Dexterity | superb | Constitution | medicore |
  | Intelligence | none          | Wisdom    | fair   |              |          |
  | Resistances  |               |           |        |              |          |
  | Physical     | none          | Mystical  | fair   |              |          |
