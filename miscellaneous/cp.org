...
** Shortest paths
*** \texorpdfstring{\(k\)}{k} shortest path
    Check [[https://en.wikipedia.org/wiki/K_shortest_path_routing][wiki]] first.

    #+ATTR_LATEX: :options [\href{https://cses.fi/problemset/task/1196}{CSES: Flight Routes}]
    #+BEGIN_problem
...
** Miscellaneous
    #+ATTR_LATEX: :options [\href{https://cses.fi/problemset/task/1682}{CSES: Flight Routes Check}]
    #+BEGIN_problem
    ...
    #+BEGIN_proof
    *Claim*: If one vertex can both reach and be reached by all others,
...
** Bottom-up segment tree
    ...
    #+ATTR_LATEX: :options [\href{https://cses.fi/problemset/task/1749/}{CSES: List Removals}]
    #+BEGIN_problem
